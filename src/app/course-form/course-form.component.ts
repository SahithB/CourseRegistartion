...
export class CourseFormComponent implements OnInit {
    ...
    if (this.id) {
      this.service
        ...
        .subscribe(c => {
          ...
          this.form
            .get("isEMIAllowed")
            .setValue(c.isEMIAllowed ? "true" : "false");
  ...
  intializeForm() {
    this.form = new FormGroup({
      ...
      fees: new FormControl("", [Validators.required, Validators.min(500)]),
  ...
  get batchSizeAvl() {
    return this.form.get("batchSizeAvl");
  }
  get duration() {
    return this.form.get("duration");
  }
  get isEMIAllowed() {
    return this.form.get("isEMIAllowed");
  }
  get allowedInstallments() {
    return this.form.get("allowedInstallments");
  }

  onChanges() {
    this.form.get("isEMIAllowed").valueChanges.subscribe(type => {
      if (type == "false") {
